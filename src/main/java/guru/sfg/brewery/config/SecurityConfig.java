...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public AbstractRestAuthFilter urlParamAuthFilter(AuthenticationManager authenticationManager) {
        AbstractRestAuthFilter filter = new UrlParamAuthFilter(new AntPathRequestMatcher("/api/**"));
        filter.setAuthenticationManager(authenticationManager);
        return filter;
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(urlParamAuthFilter(authenticationManager()), UsernamePasswordAuthenticationFilter.class)
                        .csrf().disable();
